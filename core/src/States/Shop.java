...
public class Shop extends State {
  ...
  Shop(final GameStateManager gsm, final AdsController adsController, final AssetManager manager) {
   ...
   //Achievements achievementsObject = new Achievements();
    TextureAtlas textureAtlas1 = manager.get("shared/shared.atlas", TextureAtlas.class);
    TextureAtlas textureAtlas2 = manager.get("main_game/main_game.atlas", TextureAtlas.class);
    this.shopAtlas = manager.get("shop/shop.atlas", TextureAtlas.class);
    ...
    this.shieldUpgraded = this.prefs.getInteger("shieldUpgraded", 0);
    this.abilityShieldCost = this.prefs.getInteger("abilityShieldCost", 500);
    this.magnetUpgraded = this.prefs.getInteger("magnetUpgraded", 0);
    this.abilityMagnetCost = this.prefs.getInteger("abilityMagnetCost", 500);
    this.coinRushUpgraded = this.prefs.getInteger("coinRushUpgraded", 0);
    this.abilityCoinRushCost = this.prefs.getInteger("abilityCoinRushCost", 500);
    this.spawnRateUpgraded = this.prefs.getInteger("spawnRateUpgraded", 0);
    this.abilitySpawnRateCost = this.prefs.getInteger("abilitySpawnRateCost", 500);
    this.spawnRateCoinsUpgraded = this.prefs.getInteger("spawnRateCoinsUpgraded", 0);
    this.abilitySpawnRateCoinsCost = this.prefs.getInteger("abilitySpawnRateCoinsCost", 500);
    this.notEnoughMoneyWindow = this.shopAtlas.findRegion("not_enough_coins_window");
    this.xNotEnoughMoneyButton = textureAtlas1.findRegion("congratulations_window_x_button_unpressed");
    this.quitWindowTexture = textureAtlas1.findRegion("sure_quit_window");
    this.notQuitButtonTexture = textureAtlas1.findRegion("congratulations_window_x_button_unpressed");
    this.quitButtonTexture = textureAtlas2.findRegion("story_continue_button_unpressed");
    Image image4 = new Image(textureAtlas1.findRegion("menu_background"));
    image4.setSize(Gdx.graphics.getWidth(), Gdx.graphics.getHeight());
    image4.setPosition(0.0F, 0.0F);
    this.costumeNames[0] = this.shopAtlas.findRegion("player_costume_name");
    this.costumeNames[1] = this.shopAtlas.findRegion("robot_costume_name");
    this.costumeNames[2] = this.shopAtlas.findRegion("knight_costume_name");
    this.costumeNames[3] = this.shopAtlas.findRegion("cowboy_costume_name");
    this.costumeNames[4] = this.shopAtlas.findRegion("cowgirl_costume_name");
    this.costumeNames[5] = this.shopAtlas.findRegion("ninja_male_costume_name");
    this.costumeNames[6] = this.shopAtlas.findRegion("ninja_female_costume_name");
    this.costumeNames[7] = this.shopAtlas.findRegion("dino_costume_name");
    this.costumeCosts[0] = textureAtlas2.findRegion("transparent");
    this.costumeCosts[1] = this.shopAtlas.findRegion("robot_costume_cost");
    this.costumeCosts[2] = this.shopAtlas.findRegion("knight_costume_cost");
    this.costumeCosts[3] = this.shopAtlas.findRegion("cowboy_costume_cost");
    this.costumeCosts[4] = this.shopAtlas.findRegion("cowgirl_costume_cost");
    this.costumeCosts[5] = this.shopAtlas.findRegion("ninja_male_costume_cost");
    this.costumeCosts[6] = this.shopAtlas.findRegion("ninja_female_costume_cost");
    this.costumeCosts[7] = this.shopAtlas.findRegion("dino_costume_cost");
    this.costumeImages[0] = this.shopAtlas.findRegion("player_costume");
    this.costumeImages[1] = this.shopAtlas.findRegion("robot_costume");
    this.costumeImages[2] = this.shopAtlas.findRegion("knight_costume");
    this.costumeImages[3] = this.shopAtlas.findRegion("cowboy_costume");
    this.costumeImages[4] = this.shopAtlas.findRegion("cowgirl_costume");
    this.costumeImages[5] = this.shopAtlas.findRegion("ninja_male_costume");
    this.costumeImages[6] = this.shopAtlas.findRegion("ninja_female_costume");
    this.costumeImages[7] = this.shopAtlas.findRegion("dino_costume");
    this.prefs.putBoolean("playerBought", true);
    this.prefs.flush();
    this.coin = textureAtlas1.findRegion("coin");
    this.diamond = textureAtlas1.findRegion("diamond");
    BitmapFont bitmapFont = manager.get("font/font_scale_07.fnt", BitmapFont.class);
    ...
    bitmapFont = manager.get("font/font_scale_1.fnt", BitmapFont.class);
    this.textFont = bitmapFont;
    bitmapFont.setColor(Color.WHITE);
    this.textFont.getData().setScale(worldXToScreenX(1.0F), worldYToScreenY(1.0F));
    bitmapFont = manager.get("font/font_scale_065.fnt", BitmapFont.class);
    this.smallerTextFont = bitmapFont;
    bitmapFont.setColor(Color.WHITE);
    this.smallerTextFont.getData().setScale(worldXToScreenX(0.65F), worldYToScreenY(0.65F));
    bitmapFont = manager.get("font/font_scale_09.fnt", BitmapFont.class);
    this.buyButtonTextFont = bitmapFont;
    bitmapFont.setColor(Color.BLACK);
    this.buyButtonTextFont.getData().setScale(worldXToScreenX(0.9F), worldYToScreenY(0.9F));
    Image image5 = new Image(this.shopAtlas.findRegion("power_ups_window"));
    image5.setSize(worldXToScreenX(480.0F), worldYToScreenY(700.0F));
    image5.setPosition(worldXToScreenX(10.0F), worldYToScreenY(100.0F));
    ImageButton.ImageButtonStyle imageButtonStyle3 = new ImageButton.ImageButtonStyle();
    imageButtonStyle3.up = new TextureRegionDrawable(new TextureRegion(this.shopAtlas.findRegion("power_ups_button")));
    imageButtonStyle3.down = new TextureRegionDrawable(new TextureRegion(this.shopAtlas.findRegion("power_ups_button")));
    ImageButton imageButton4 = new ImageButton(imageButtonStyle3);
    imageButton4.setPosition(worldXToScreenX(60.0F), worldYToScreenY(790.0F));
    imageButton4.setSize(worldXToScreenX(120.0F), worldYToScreenY(120.0F));
    imageButton4.addListener(new ClickListener() {
          public void touchUp(InputEvent param1InputEvent, float param1Float1, float param1Float2, int param1Int1, int param1Int2) {
            ...
            Shop.access$002(Shop.this, true);
            Shop.access$102(Shop.this, false);
            Shop.this.drawAbilityElements();
            Shop.this.musicSoundsObject.playButtonClick();
          }
        });
    Image image3 = new Image(new TextureRegionDrawable(new TextureRegion(this.shopAtlas.findRegion("not_enough_diamonds_window"))));
    this.notEnoughCoinsDiamondsWindow = image3;
    image3.setSize(worldXToScreenX(480.0F), worldYToScreenY(180.0F));
    this.notEnoughCoinsDiamondsWindow.setPosition(worldXToScreenX(10.0F), worldYToScreenY(410.0F));
    ImageButton.ImageButtonStyle imageButtonStyle4 = new ImageButton.ImageButtonStyle();
    imageButtonStyle4.up = new TextureRegionDrawable(new TextureRegion(textureAtlas1.findRegion("congratulations_window_x_button_unpressed")));
    imageButtonStyle4.down = new TextureRegionDrawable(new TextureRegion(textureAtlas1.findRegion("congratulations_window_x_button_pressed")));
    ImageButton imageButton6 = new ImageButton(imageButtonStyle4);
    imageButton6.setPosition(worldXToScreenX(420.0F), worldYToScreenY(525.0F));
    imageButton6.setSize(worldXToScreenX(50.0F), worldYToScreenY(50.0F));
    imageButton6.addListener(new ClickListener() {
          public void touchUp(InputEvent param1InputEvent, float param1Float1, float param1Float2, int param1Int1, int param1Int2) {
            super.touchUp(param1InputEvent, param1Float1, param1Float2, param1Int1, param1Int2);
            Shop.access$402(Shop.this, false);
            Shop.this.stage.getActors().get(19).setVisible(false);
            Shop.this.stage.getActors().get(20).setVisible(false);
    ...
    this.shield = textureAtlas2.findRegion("shield_collectible");
    this.abilityPointsShield = new ArrayList<AbilityPoint>();
    byte b;
    for (b = 0; b < 10; b++)
    ...
    this.magnet = textureAtlas2.findRegion("coin_magnet");
    ...
    this.coinRush = textureAtlas2.findRegion("coin_rush");
    ...
    imageButton14 = new ImageButton(imageButtonStyle4);
    ...
    imageButtonStyle10.up = new TextureRegionDrawable(new TextureRegion(textureAtlas2.findRegion("story_continue_button_unpressed")));
    imageButtonStyle10.down = new TextureRegionDrawable(new TextureRegion(textureAtlas2.findRegion("story_continue_button_pressed")));
    ...
    ImageButton imageButton28 = new ImageButton(imageButtonStyle4);
    ...
    imageButtonStyle21.up = new TextureRegionDrawable(new TextureRegion(textureAtlas1.findRegion("back_button_unpressed")));
    imageButtonStyle21.down = new TextureRegionDrawable(new TextureRegion(textureAtlas1.findRegion("back_button_pressed")));
    ...
    Image image1 = new Image(textureAtlas1.findRegion("sure_quit_window"));
    ...
    imageButtonStyle1.up = new TextureRegionDrawable(new TextureRegion(textureAtlas1.findRegion("congratulations_window_x_button_unpressed")));
    imageButtonStyle1.down = new TextureRegionDrawable(new TextureRegion(textureAtlas1.findRegion("congratulations_window_x_button_pressed")));
    ...
    imageButtonStyle2.up = new TextureRegionDrawable(new TextureRegion(textureAtlas2.findRegion("story_continue_button_unpressed")));
    imageButtonStyle2.down = new TextureRegionDrawable(new TextureRegion(textureAtlas2.findRegion("story_continue_button_pressed")));
