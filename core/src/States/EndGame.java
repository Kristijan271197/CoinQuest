...
//    TextureAtlas textureAtlas2 = manager.get("main_menu/main_menu.atlas", TextureAtlas.class);
//    TextureAtlas textureAtlas3 = manager.get("shared/shared.atlas", TextureAtlas.class);
//    TextureAtlas textureAtlas1 = manager.get("main_game/main_game.atlas", TextureAtlas.class);
//    TextureAtlas textureAtlas4 = manager.get("end_game/end_game.atlas", TextureAtlas.class);
...
//    BitmapFont bitmapFont = manager.get("font/font_end_game.fnt", BitmapFont.class);
...
//    bitmapFont = manager.get("font/font_end_game_smaller.fnt", BitmapFont.class);
...
//    Image image4 = new Image(textureAtlas3.findRegion("menu_background"));
//    image4.setSize(Gdx.graphics.getWidth(), Gdx.graphics.getHeight());
//    image4.setPosition(0.0F, 0.0F);
//    Image image6 = new Image(textureAtlas4.findRegion("score_table"));
...
//    Image image5 = new Image(textureAtlas4.findRegion("player_image"));
...
//      image5.setDrawable(new TextureRegionDrawable(new TextureRegion(textureAtlas4.findRegion("player_image"))));
...
//      image5.setDrawable(new TextureRegionDrawable(new TextureRegion(textureAtlas4.findRegion("robot_image"))));
//    } else if (this.prefs.getInteger("costumeSelectedGame") == 2) {
//      image5.setSize(worldXToScreenX(140.0F), worldYToScreenY(200.0F));
//      image5.setDrawable(new TextureRegionDrawable(new TextureRegion(textureAtlas4.findRegion("knight_image"))));
//    } else if (this.prefs.getInteger("costumeSelectedGame") == 3) {
//      image5.setSize(worldXToScreenX(131.0F), worldYToScreenY(200.0F));
//      image5.setDrawable(new TextureRegionDrawable(new TextureRegion(textureAtlas4.findRegion("cowboy_image"))));
//    } else if (this.prefs.getInteger("costumeSelectedGame") == 4) {
//      image5.setSize(worldXToScreenX(124.0F), worldYToScreenY(200.0F));
//      image5.setDrawable(new TextureRegionDrawable(new TextureRegion(textureAtlas4.findRegion("cowgirl_image"))));
//    } else if (this.prefs.getInteger("costumeSelectedGame") == 5) {
//      image5.setSize(worldXToScreenX(109.0F), worldYToScreenY(200.0F));
//      image5.setDrawable(new TextureRegionDrawable(new TextureRegion(textureAtlas4.findRegion("ninja_male_image"))));
//    } else if (this.prefs.getInteger("costumeSelectedGame") == 6) {
//      image5.setSize(worldXToScreenX(120.0F), worldYToScreenY(200.0F));
//      image5.setDrawable(new TextureRegionDrawable(new TextureRegion(textureAtlas4.findRegion("ninja_female_image"))));
//    } else if (this.prefs.getInteger("costumeSelectedGame") == 7) {
//      image5.setSize(worldXToScreenX(188.0F), worldYToScreenY(200.0F));
//      image5.setDrawable(new TextureRegionDrawable(new TextureRegion(textureAtlas4.findRegion("dino_image"))));
//    }
...
//    imageButtonStyle4.up = new TextureRegionDrawable(new TextureRegion(textureAtlas4.findRegion("triple_coins_ad_button_unpressed")));
//    this.tripleCoinsAdButtonTexture.down = new TextureRegionDrawable(new TextureRegion(textureAtlas4.findRegion("triple_coins_ad_button_pressed")));
//    imageButtonStyle4 = new ImageButton.ImageButtonStyle();
//    this.tripleCoinsAdWaitButtonTexture = imageButtonStyle4;
//    imageButtonStyle4.up = new TextureRegionDrawable(new TextureRegion(textureAtlas1.findRegion("ad_wait_button")));
//    this.tripleCoinsAdWaitButtonTexture.down = new TextureRegionDrawable(new TextureRegion(textureAtlas1.findRegion("ad_wait_button")));
...
//    this.tripleCoinsAdButton.addListener(new ClickListener() {
...
//          }
//        });
//    Image image3 = new Image(textureAtlas4.findRegion("triple_coins_arrow"));
...
//    imageButtonStyle3.up = new TextureRegionDrawable(new TextureRegion(textureAtlas1.findRegion("main_game_restart_button_unpressed")));
//    imageButtonStyle3.down = new TextureRegionDrawable(new TextureRegion(textureAtlas1.findRegion("main_game_restart_button_pressed")));
...
//          public void touchUp(InputEvent param1InputEvent, float param1Float1, float param1Float2, int param1Int1, int param1Int2) {
//            super.touchUp(param1InputEvent, param1Float1, param1Float2, param1Int1, param1Int2);
//            EndGame.this.gsm.set(new MainGame(EndGame.this.gsm, adsController, manager, stageNumber));
//            EndGame.this.musicSoundsObject.playButtonClick();
//            EndGame.this.dispose();
//          }
//        });
//    Image image2 = new Image(textureAtlas3.findRegion("congratulations_window"));
...
//    imageButtonStyle5.up = new TextureRegionDrawable(new TextureRegion(textureAtlas3.findRegion("congratulations_window_x_button_unpressed")));
//    imageButtonStyle5.down = new TextureRegionDrawable(new TextureRegion(textureAtlas3.findRegion("congratulations_window_x_button_pressed")));
...
//    imageButtonStyle6.up = new TextureRegionDrawable(new TextureRegion(textureAtlas1.findRegion("main_game_menu_button_unpressed")));
//    imageButtonStyle6.down = new TextureRegionDrawable(new TextureRegion(textureAtlas1.findRegion("main_game_menu_button_pressed")));
...
//    imageButtonStyle7.up = new TextureRegionDrawable(new TextureRegion(textureAtlas2.findRegion("shop_button_unpressed")));
//    imageButtonStyle7.down = new TextureRegionDrawable(new TextureRegion(textureAtlas2.findRegion("shop_button_pressed")));
...
//          }
//        });
//    Image image1 = new Image(textureAtlas3.findRegion("sure_quit_window"));
...
//    imageButtonStyle1.up = new TextureRegionDrawable(new TextureRegion(textureAtlas3.findRegion("congratulations_window_x_button_unpressed")));
//    imageButtonStyle1.down = new TextureRegionDrawable(new TextureRegion(textureAtlas3.findRegion("congratulations_window_x_button_pressed")));
...
//          public void touchUp(InputEvent param1InputEvent, float param1Float1, float param1Float2, int param1Int1, int param1Int2) {
//            super.touchUp(param1InputEvent, param1Float1, param1Float2, param1Int1, param1Int2);
//            EndGame.this.stage.getActors().get(9).setVisible(false);
//            EndGame.this.stage.getActors().get(10).setVisible(false);
//            EndGame.this.stage.getActors().get(11).setVisible(false);
//            EndGame.this.musicSoundsObject.playButtonClick();
//          }
//        });
//    ImageButton.ImageButtonStyle imageButtonStyle2 = new ImageButton.ImageButtonStyle();
//    imageButtonStyle2.up = new TextureRegionDrawable(new TextureRegion(textureAtlas1.findRegion("story_continue_button_unpressed")));
//    imageButtonStyle2.down = new TextureRegionDrawable(new TextureRegion(textureAtlas1.findRegion("story_continue_button_pressed")));
...
//    this.stage.addActor(this.tripleCoinsAdButton);
...
//    if (bool1) {
//      this.tripleCoinsAdButton.setStyle(this.tripleCoinsAdButtonTexture);
//      this.stage.getActors().get(3).setTouchable(Touchable.enabled);
//    } else {
//      this.tripleCoinsAdButton.setStyle(this.tripleCoinsAdWaitButtonTexture);
...
//    this.scoreFont.draw(paramSpriteBatch, String.valueOf(this.score), worldXToScreenX(330.0F), worldYToScreenY(815.0F), worldXToScreenX(30.0F), 1, true);
//    this.coinsHighScoreFont.draw(paramSpriteBatch, String.valueOf(this.coinCount), worldXToScreenX(330.0F), worldYToScreenY(735.0F), worldXToScreenX(30.0F), 1, true);
...
//        bitmapFont.draw(paramSpriteBatch, stringBuilder.toString(), worldXToScreenX(330.0F), worldYToScreenY(665.0F), worldXToScreenX(30.0F), 1, true);
//      } else {
//        this.coinsHighScoreFont.draw(paramSpriteBatch, "100%", worldXToScreenX(330.0F), worldYToScreenY(665.0F), worldXToScreenX(30.0F), 1, true);
//      }
//    } else if (i == 2) {
...
//      bitmapFont.draw(paramSpriteBatch, stringBuilder.toString(), worldXToScreenX(100.0F), worldYToScreenY(510.0F), worldXToScreenX(300.0F), 1, false);
//    }
