...
public class MusicSounds {
  ...
  public MusicSounds(AssetManager paramAssetManager) {
    this.buttonClick = (Sound)paramAssetManager.get("music/button_click.mp3", Sound.class);
    this.buttonReceiveCoins = (Sound)paramAssetManager.get("music/receive_coins.mp3", Sound.class);
    this.buttonBuy = (Sound)paramAssetManager.get("music/button_buy.mp3", Sound.class);
    this.coinCollect = (Sound)paramAssetManager.get("music/coin_collect.mp3", Sound.class);
    this.rockHit = (Sound)paramAssetManager.get("music/rock_hit.mp3", Sound.class);
    this.bombSound = (Sound)paramAssetManager.get("music/bomb_explode.mp3", Sound.class);
    this.playerGround = (Sound)paramAssetManager.get("music/player_ground.mp3", Sound.class);
    this.jump = (Sound)paramAssetManager.get("music/jump.mp3", Sound.class);
    this.wheelReward = (Sound)paramAssetManager.get("music/wheel_reward.mp3", Sound.class);
    this.wheelSpin = (Music)paramAssetManager.get("music/wheel_of_fortune.mp3", Music.class);
    this.backgroundMusic = (Music)paramAssetManager.get("music/fun_adventure.ogg", Music.class);
...
/* Location:              C:\Users\nikol\Desktop\dex-tools-2.1-SNAPSHOT\kiki-dex2jar.jar!\States\MusicSounds.class
